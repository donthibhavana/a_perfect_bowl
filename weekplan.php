...
<body style="background-image: url('images/bggg.jpeg');">
  ...
  <ul class="nav justify-content-center" style="margin-top:30px">
    ...
    padding-left: 10px;">
              ...
              <h1 style="text-align:center;color: #28a745;">Weekly Plan</h1>
              <h4 style="text-align:center">Choose any plan from given 3 choices</h4>
            </div>
            </div>
    ...
    padding-left: 10px;text-align:center">
           ...
           <img src="images/bwl.png" /><br/>
               <span style="color: #28a745;
    background-color: none;font-size:25px">Bowl for Breakfast</span> 
    ...
    <div class="container">
        <div class="row" style="margin-top:50px">
              <?php
                            ...
                            $sql = "SELECT * FROM recipes where rid='1' ORDER BY RAND ( ) LIMIT 7  ";
                            ...
                            if ($result->num_rows > 0) {
                               ...
                               <div class="col-md-4">
                                   ...
                                   <a href="recipedetails.php?id=' . $row["id"] . '&cate=' . $row["name"] . '" style="color: #007bff;">
                                   <img src="' . $row["image"] . '"  style="width:100%;height:100px" class="img-thumbnail"/>
    ...
    padding-left: 10px;text-align:center">
               <img src="images/bwl.png" /><br/>
               <span style="color: #28a745;
    background-color: none;font-size:25px">Bowl for Lunch</span> 
      ...
      <div class="container">
        <div class="row" style="margin-top:50px">
              <?php
                            ...
                            $sql = "SELECT * FROM recipes where rid='2' ORDER BY RAND ( ) LIMIT 7  ";
                            $result = $conn->query($sql);
    ...
    padding-left: 10px;text-align:center">
               <img src="images/bwl.png" /><br/>
               <span style="color: #28a745;
    background-color: none;font-size:25px">Bowl for Dinner</span> 
      <div class="container">
        <div class="row" style="margin-top:50px">
              <?php
                                       //session_start(); 
                            ...
                            $sql = "SELECT * FROM recipes where rid='3' ORDER BY RAND ( ) LIMIT 7  ";
                            $result = $conn->query($sql);
