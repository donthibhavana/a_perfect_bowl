...
<h2 style="margin-top:50px;color: #28a745;text-align:center">Customize Meal</h2>
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top:20px;text-align:left">
                 
                 <form method="POST" action="customize.php" enctype="multipart/form-data">
                              
                              
                               <div class="form-group">
                                    <label for="ing1">Select Ingredient One</label>
                                    <select class="form-control" name="ing1" style="width:200px;text-align:left">
                                        <?php
                            ...
                            $conn->close();
                                 ...
                                 <div class="form-group">
                                    <label for="ing1">Select Ingredient Two</label>
                                    <select class="form-control" name="ing2" style="width:200px;text-align:left">
                                        <?php
                            ...
                            $conn->close();
                                ...
                                <button type="submit" class="form-control btn btn-success" style="width:200px;border-radius: 20px;">Submit</button>
                            </form>
           ...
           <div class="col-md-4" style="margin-top:20px;text-align:left">
                 ...
                 <form method="POST" action="customize1.php" enctype="multipart/form-data">
