  ...
  <ul class="nav justify-content-center" style="margin-top:30px">
    ...
    <div class="container-fluid" style="margin-top:30px">
        <div class="row">
            ...
            <div class="col-md-8">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Add Kitchen Tips</button>
                <br/>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title">Add Kitchen Tips</h4>
                        </div>
                        <div class="modal-body">
                          <form method="POST" action="addtips.php" enctype="multipart/form-data">
                        ...
                        if ($result) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <td> 
                                 ...
                                 <a   data-toggle='modal' data-target='#" . $row["tid"] . "' style='cursor:pointer'>
                                         <button class='btn btn-success' >Edit </button>
                                    </a>
                                    
                                    
                                    <div class='modal fade' id='" . $row["tid"] . "'   role='dialog'   aria-hidden='true'>
                                    <div class='modal-dialog' role='document'>
                                        <div class='modal-content'>
                                            ...
                                            <div class='modal-body'>
                                                ...
                                                <form method='POST' action='edittips.php' >
                
                                                <input type='text' class='form-control' name='id' value='" . $row["tid"] . "' hidden  readonly>
                                        ...
                                        <a href='deletetips.php?id=" . $row['tid'] . "'>
