  ...
  <ul class="nav justify-content-center" style="margin-top:30px">
    ...
    <div class="container" style="margin-top:30px">
        <div class="row">
            ...
            <div class="col-md-12">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Add Recipes</button>
                <br/>
                          ...
                          <form method="POST" action="addrecipe.php" enctype="multipart/form-data">
                              ...
                              <div class="container">
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group">
                                            <label for="name">Select Recipe Category</label>
                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ing3" id="ing3" required="">
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
                                            <label for="ingothers">Other Ingredients</label>
                                            <input type="text" class="form-control" name="ingothers" id="ingothers" required="">
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                            <label for="step4">Other Ingredients</label>
                                            <input type="text" class="form-control" name="step4" id="step4" required="">
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group">
                                            <label for="prep">Preparation Time (In minutes)</label>
                                            <input type="number" class="form-control" name="prep" id="prep" required="">
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
                                            <label for="cook">Cook Time (In minutes)</label>
                                            <input type="number" class="form-control" name="cook" id="cook" required="">
                                          </div>
                                      </div>
                                  </div>
                ...
                <table class="table table-stripped table-bordered">
                        ...
                        if ($result) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <td> " . $row['cook'] . "</td>
                                <td> 
                                        <a href='deleterecipe.php?id=" . $row['id'] . "'>
